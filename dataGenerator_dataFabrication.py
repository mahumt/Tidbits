# https://www.youtube.com/watch?v=efglrrTwdCo&list=WL&index=51&t=372s&ab_channel=CodeWithYu
# python -m pip install blinker click Faker Flask itsdangerous Jinja2 MarkupSafe psycopg2 python-dateutil six Werkzeug
